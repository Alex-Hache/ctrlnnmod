...
from ctrlnmod.losses import MSELoss, NMSELoss, FitPercentLoss, RMSELoss, NRMSELoss
from ctrlnmod.regularizations import L1Regularization
...
class TestLosses(unittest.TestCase):
    ...
    def test_fitpercent_loss_with_regularization(self):
        ...
        self.assertIsInstance(loss_value, torch.Tensor)
        self.assertTrue(loss_value.item() <= 100)
