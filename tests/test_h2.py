...
from ctrl_nmod.models.ssmodels.h2 import H2BoundedLinear
...
from ctrl_nmod.lmis.h2 import H2Cont
...
_, gamma2, P = H2Cont.solve(A0, B0, C0)
model = H2BoundedLinear(nu, ny, nx, float(gamma2))
